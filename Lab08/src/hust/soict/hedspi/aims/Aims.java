...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        Book book1 = new Book("minh thu1", "abc1",40, new ArrayList<>(Arrays.asList("Minh1", " Hai Long1")));
        Book book2 = new Book("minh thu2", "abc2", 50,new ArrayList<>(Arrays.asList("Minh2", " Hai Long2")));
        Book book3 = new Book("minh thu3", "abc3",60, new ArrayList<>(Arrays.asList("Minh3", " Hai Long3")));
        Book book4 = new Book("minh thu4", "abc4",45, new ArrayList<>(Arrays.asList("Minh4", " Hai Long4")));
        DigitalVideoDisc dvd1 = new DigitalVideoDisc("dvd1", "abc1", 30,40, "xyz1");
        DigitalVideoDisc dvd2 = new DigitalVideoDisc("dvd2", "abc2", 30,50, "xyz2");
        DigitalVideoDisc dvd3 = new DigitalVideoDisc("dvd3", "abc3", 30, 60,"xyz3");
        CompactDisc cd1 = new CompactDisc("cd1", "abc1", 40,60, "xyz1", "ght1", new ArrayList<Track>(Arrays.asList(new Track("123", 30), new Track("789", 56))));
        CompactDisc cd2 = new CompactDisc("cd2", "abc2", 40, 55,"xyz2", "ght2", new ArrayList<Track>(Arrays.asList(new Track("123", 30), new Track("789", 56))));
        CompactDisc cd3 = new CompactDisc("cd3", "abc3", 40, 61,"xyz3", "ght3", new ArrayList<Track>(Arrays.asList(new Track("123", 30), new Track("789", 56))));
        showMenu();
