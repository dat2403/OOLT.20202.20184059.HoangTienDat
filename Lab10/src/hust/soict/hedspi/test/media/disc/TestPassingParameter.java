package hust.soict.hedspi.test.media.disc;
...
public class TestPassingParameter {
	...
	public static void main(String[] args) {
		...
		DigitalVideoDisc jungleDVD = new DigitalVideoDisc("1","Jugle",null, 20.4f);
		DigitalVideoDisc cinderellaDVD = new DigitalVideoDisc("2","Cinderella",null, 15.6f);
